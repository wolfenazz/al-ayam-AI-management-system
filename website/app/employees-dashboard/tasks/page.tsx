                        ...
                        {statusOptions.map((opt) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors ${statusFilter === opt.value
                                    ...
                                    : 'bg-card border border-border text-text-secondary hover:bg-surface'
                                    }`}
                            >
                                {opt.label}
                            </button>
                ...
                <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
                    {isLoading ? (
                        ...
                        <div className="p-12 text-center">
                            <div className="size-16 bg-surface rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <div key={task.id} className="p-6 hover:bg-surface/50 transition-colors group">
                                    <div className="flex items-start justify-between gap-4 mb-2">
                                        <div className="flex items-center gap-3">
                                            <span className={`px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider ${task.location ? 'bg-blue-100 text-blue-700' : 'bg-surface text-text-secondary'
                                                }`}>
