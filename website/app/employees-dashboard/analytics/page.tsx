            ...
            <div className="max-w-5xl mx-auto">
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl border border-border p-6 shadow-sm md:col-span-2">
                            <h3 className="text-lg font-bold text-text-primary mb-6">Task Types</h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {sortedTypes.map(([type, count]) => (
                                    <div key={type} className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
